...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("You must provide number format");
        }
    ...
    private static MonthYear getMonthYear (String[] args) throws Exception {
        ...
        int month = args.length > 1 ? Integer.parseInt(args[1]) : currentDate.getMonthValue();
        int year = args.length > 0 ? Integer.parseInt(args[0]) : currentDate.getYear();
